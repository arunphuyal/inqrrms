...
return [
    ...
    'settings' => [
        ...
        'taxTable' => 'All Taxes',
        'cbmsTab' => 'e-Billing (IRD/CBMS)',
        'cbmsSettingsTitle' => 'IRD Central Billing Monitoring System',
        'cbmsSettingsDescription' => 'Automatically report issued bills and credit notes (sales returns) to Nepal\'s IRD Central Billing Monitoring System in real time, as required for VAT-registered businesses.',
        'cbmsEnable' => 'Enable CBMS Sync',
        'cbmsEnableHelp' => 'When enabled, every order marked as paid is reported to CBMS as a bill, and cancelling an already-reported order sends a credit note.',
        'cbmsMode' => 'Mode',
        'cbmsModeTest' => 'Test',
        'cbmsModeLive' => 'Live',
        'cbmsModeHelp' => 'Use Test mode with IRD\'s demo credentials while verifying the integration. Switch to Live and enter your real Taxpayer Portal credentials to submit real bills.',
        'cbmsUsername' => 'Username',
        'cbmsUsernameHelp' => 'Taxpayer Portal login UserID (use "Test_CBMS" in Test mode).',
        'cbmsPassword' => 'Password',
        'cbmsPasswordHelp' => 'Taxpayer Portal login Password (use "test@321" in Test mode). Update this here whenever you change it on the Taxpayer Portal.',
        'cbmsSellerPan' => 'Seller PAN Override',
        'cbmsSellerPanHelp' => 'Optional. By default the PAN/VAT number configured on each order\'s branch is used. Set this only if CBMS should always use a specific PAN regardless of branch.',
        'cbmsFiscalYear' => 'Nepali Fiscal Year',
        'cbmsFiscalYearHelp' => 'The current Nepali fiscal year in CBMS\'s format, e.g. "2082.083". Update this once a year at the Shrawan 1 (BS) fiscal year rollover.',
        'cbmsLogsTitle' => 'Recent Submissions',
        'cbmsLogsEmpty' => 'No CBMS submissions yet.',
        'cbmsLogOrder' => 'Order',
        'cbmsLogType' => 'Type',
        'cbmsLogTypeBill' => 'Bill',
        'cbmsLogTypeCreditNote' => 'Credit Note',
        'cbmsLogStatus' => 'Status',
        'cbmsLogResponse' => 'Response',
        'cbmsLogSubmittedAt' => 'Submitted At',
        'cbmsRetry' => 'Retry',
        'enterAmount' => 'Enter Amount',
        'phoneNumber' => 'Phone Number',
        'customerSiteLanguage' => 'Customer Site Language',
    ...
    'update' => [
        ...
        'fileReplaceAlert' => 'To update the InQRRMS to the new version check documentation for the instructions.',
    ...
    'billing' => [
        ...
        'uploadPaymentQrCode' => 'Upload QR Code',
        'paymentQrCodeHelp' => 'Upload a scannable QR code (e.g. UPI/bank QR) for this payment method. Customers will see it at checkout.',
        'razorpay' => 'Razorpay',
        'stripe' => 'Stripe',
        'flutterwave' => 'Flutterwave',
    ...
    'cashRegister' => [
        ...
        'register' => 'Register',
        'registers' => 'Registers',
        'registersDescription' => 'Named tills a branch can open a cash session against.',
        'addRegister' => 'Add Register',
        'registerName' => 'Register Name',
        'branch' => 'Branch',
        'noRegisters' => 'No registers found.',
        'deleteRegister' => 'Delete Register',
        'deleteRegisterConfirm' => 'Are you sure you want to delete this register?',
        'approvalSettings' => 'Approval Settings',
        'approvalSettingsDescription' => 'Control when a register close-out needs a manager\'s review.',
        'requireDenominationCount' => 'Require Denomination Count',
        'requireDenominationCountHelp' => 'Cashiers must count cash note-by-note and coin-by-coin when opening/closing a register.',
        'requireApprovalOnDiscrepancy' => 'Require Approval on Discrepancy',
        'requireApprovalOnDiscrepancyHelp' => 'Send a register to Approvals when the counted amount differs from the expected amount by more than the threshold below.',
        'discrepancyThreshold' => 'Discrepancy Threshold',
        'alwaysRequireApproval' => 'Always Require Approval',
        'alwaysRequireApprovalHelp' => 'Every register close-out needs manager approval, regardless of discrepancy.',
        'denominations' => 'Denominations',
        'denominationsDescription' => 'Currency notes and coins used when counting cash.',
        ...
        'note' => 'Note',
        'coin' => 'Coin',
        'noDenominations' => 'No denominations found.',
        'deleteDenomination' => 'Delete Denomination',
        'deleteDenominationConfirm' => 'Are you sure you want to delete this denomination?',
        ...
        'noActiveRegisters' => 'No active registers are set up for this branch yet. Ask an admin to add one in Register Settings.',
        'open' => 'Open',
        'closed' => 'Closed',
        'openedBy' => 'Opened by',
        'closedBy' => 'Closed by',
        ...
        'cashIn' => 'Cash In',
        'cashOut' => 'Cash Out',
        'cashOutAndExpense' => 'Cash Out / Expense',
        'expense' => 'Expense',
        'noTransactionsYet' => 'No transactions yet.',
        'reports' => 'Reports',
        'noSessionsFound' => 'No sessions found.',
        'approvals' => 'Approvals',
        'approvalsDescription' => 'Register close-outs awaiting manager review.',
        'noPendingApprovals' => 'Nothing is waiting for approval right now.',
        'review' => 'Review',
        'approve' => 'Approve',
        'reject' => 'Reject',
        'approvalNote' => 'Note',
        ...
        'approved' => 'Approved',
        'rejected' => 'Rejected',
        'registersOpenNow' => 'Registers Open Now',
        'sessionsToday' => 'Sessions Opened Today',
    ...
    'hotel' => [
        'title' => 'Hotel',
        'description' => 'A full front-desk and hotel management module - rooms, reservations, housekeeping, and billing - is on the roadmap. This module is now toggleable per subscription package and per staff role, ready for when it ships.',
        ...
        'guestRevenueReport' => 'Guest Revenue Report',
        'fbDebtors' => 'F&B Debtors',
        'salesByWaiter' => 'Sales by Waiter',
        'banquetAndEvents' => 'Banquet & Events',
    ...
    'inventory' => [
        'title' => 'Inventory',
        'description' => 'A full inventory, recipe costing, and procurement module is on the roadmap. This module is now toggleable per subscription package and per staff role, ready for when it ships.',
        'dashboard' => 'Dashboard',
        'units' => 'Units',
