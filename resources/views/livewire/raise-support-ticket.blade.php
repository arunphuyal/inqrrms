        ...
        <div class="max-w-4xl mx-auto px-4">
            ...
            <div class="space-y-6">
                ...
                <div class="bg-gradient-to-br from-indigo-50 to-purple-50 dark:from-indigo-900/20 dark:to-purple-900/20 rounded-xl p-6 border border-indigo-200 dark:border-indigo-700 relative">
                    ...
                    <div class="flex">
                        <a href="https://envato.froid.works/priority-support?purchase_code={{ global_setting()->purchase_code }}&utm_source=inqrrms_app&utm_campaign=priority_support" target="_blank" 
